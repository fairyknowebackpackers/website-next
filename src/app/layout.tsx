        ...
        <footer className="relative mt-2">
          ...
          <div className="relative sm:hidden bg-white pb-2">
            ...
            <div className="flex justify-center space-x-6 mb-4">
              ...
              {/* Instagram Button */}
              <a href="https://instagram.com/fairyknowe" className="text-gray-900 hover:text-primary transition-colors" title="Follow us on Instagram" target="_blank" rel="nofolow noopener">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
