...
const images = [
  ...
  {
    src: '/gypsy-caravan-5.jpg',
    alt: 'Gypsy Caravan Additional View 1',
    description: 'Additional view of the caravan'
  },
  {
    src: '/gypsy-caravan-6.jpg',
    alt: 'Gypsy Caravan Additional View 2',
    description: 'Another view of the caravan'
  },
  {
    src: '/gypsy-caravan-7.jpg',
    alt: 'Gypsy Caravan Additional View 3',
    description: 'More views of the caravan'
  },
  {
    src: '/gypsy-caravan-8.jpg',
    alt: 'Gypsy Caravan Additional View 4',
    description: 'Final view of the caravan'
  }
]
