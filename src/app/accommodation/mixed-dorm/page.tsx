...
const images = [
  ...
  {
    src: '/mixed-dorm-5.jpg',
    alt: 'Mixed Dorm Additional View 1',
    description: 'Additional view of the dorm'
  },
  {
    src: '/mixed-dorm-6.jpg',
    alt: 'Mixed Dorm Additional View 2',
    description: 'Another view of the dorm'
  },
  {
    src: '/mixed-dorm-7.jpg',
    alt: 'Mixed Dorm Additional View 3',
    description: 'More views of the dorm'
  },
  {
    src: '/mixed-dorm-8.jpg',
    alt: 'Mixed Dorm Additional View 4',
    description: 'Final view of the dorm'
  }
]
